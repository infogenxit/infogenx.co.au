        ...
        <div className="business-impact-grid">
          <div className="impact-card">
            <div className="impact-image">
              <img src={Business1} alt="Consulting and advisory impact visual 1" />
            </div>
          ...
          <div className="impact-card">
            <div className="impact-image">
              <img src={Business2} alt="Consulting and advisory impact visual 2" />
            </div>
            <div className="impact-content">
          ...
          <div className="impact-card">
            <div className="impact-image">
              <img src={Business3} alt="Consulting and advisory impact visual 3" />
            </div>
            <div className="impact-content">
          ...
          <div className="impact-card">
            <div className="impact-image">
              <img src={Business4} alt="Consulting and advisory impact visual 4" />
            </div>
            <div className="impact-content">
