...
const GetinTouchNew = () => {
  ...
  const handleSubmit = (e) => {
    ...
    try {
      ...
      addField("zf_redirect_url", "https://infogenx.com.au/");
  ...
  const handleSubmitAI = (e) => {
    ...
    try {
      ...
      addField("zf_redirect_url", `${process.env.REACT_APP_SITE_URL || "https://infogenx.com.au"}/contact-us`);
      addField("zc_gad", "");
  ...
  */
  ...
  return (
    ...
    `}
      ...
      {/* 
      RESTORED CODE (Commented): New Sections and Modals
      /*
