...
const ApiIntegration = () => {
  const apiContent = [
    {
      heading: "Systems Integration in Australia Without Breaking What Already Works",
      content: [
        ...
        "With our systems integration services across Australia, we close those gaps properly. We don’t replace your systems unless it’s necessary. We integrate what you already use and make it work together properly."
      ],
      list: [
    ...
    },
    {
      ...
      content: [
        ...
        "With our API integration services, we automate how data moves across your systems. The goal is not just integration — it’s operational clarity. When data flows properly, your business runs cleaner and faster."
      ],
      list: [
  ...
  const faqs = [
    {
      question: "What does API integration actually solve for Australian businesses?",
  ...
  return (
    <>
      <SEO
        title="API Integration & Systems Connectivity Experts | Infogenx Australia"
        description="Infogenx provides seamless API integration and systems connectivity solutions for Australian organizations to connect applications, automate workflows, and improve efficiency."
        keywords="API integration Australia, Systems Integration, Software connectivity, Infogenx"
      />
